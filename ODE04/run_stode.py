...
def main(args):
    ...
    A_lst = np.load('/home/user/pan/project/ODE04_sp/04pre_adj_V2.npy')
    # A[np.isnan(A)] = 0.
    # A[np.isinf(A)] = 0.
    ...
    g1_train = sp_g[0:486]
    A_hat1_train = A_sp_wave[0:486]

    g1_valid = sp_g[486:648]
    A_hat1_valid = A_sp_wave[486:648]

    g1_test = sp_g[648:809]
    A_hat1_test = A_sp_wave[648:809]

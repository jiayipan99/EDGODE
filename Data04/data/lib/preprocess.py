...
import numpy as np
# import mxnet as mx
from TDGCN.Data08.utils.data_util import get_sample_indices
...
def read_and_generate_dataset(graph_signal_matrix_filename, num_of_weeks, num_of_days, num_of_hours, num_for_predict,
    ...
    print("                  week_shape  	 	   day_shape           hour_shape         target_shape")
    print('train data    {}   {}   {}   {}'.format(train_week.shape, train_day.shape, train_hour.shape,
                                                   train_target.shape))
